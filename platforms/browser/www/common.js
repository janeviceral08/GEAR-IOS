...
/*!*******************************************!*\
  !*** ./src/app/services/leave.service.ts ***!
  \*******************************************/
/*! exports provided: LeaveType, LeaveTime, Reason, LeaveService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LeaveType", function() { return LeaveType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LeaveTime", function() { return LeaveTime; });
...
var Reason;
(function (Reason) {
    Reason["personal"] = "LVR00001";
    Reason["notwell"] = "LVR00002";
})(Reason || (Reason = {}));
var LeaveService = /** @class */ (function () {
    function LeaveService(http, storage, httpApi) {
        var _this = this;
        this.http = http;
        ...
        this.noError = true;
        this.sidebarVisibilityChange = new rxjs__WEBPACK_IMPORTED_MODULE_4__["Subject"]();
        this.sidebarVisibilityChange.subscribe(function (value) {
            _this.testString = value;
        });
    }
    LeaveService.prototype.getLeaveCredits = function () {
        ...
        //   )
        // );
        this.results = this.http.get(src_app_utils_constants_service__WEBPACK_IMPORTED_MODULE_7__["API_ENDPOINT"] + "/api/leaverequest/findall?employeeid=10145").pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (results) {
            return results['Value']['tblLeaveCredit'];
        }));
    };
    LeaveService.prototype.getLeaveList = function (employeeid) {
        return this.http.get(src_app_utils_constants_service__WEBPACK_IMPORTED_MODULE_7__["API_ENDPOINT"] + "/api/leaverequest/findall?employeeid=" + employeeid).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (results) {
            return results['Value']['tblLeaveRequest'];
        }));
    };
    LeaveService.prototype.requestLeave = function () {
        var _this = this;
        this.httpApi.get(src_app_utils_constants_service__WEBPACK_IMPORTED_MODULE_7__["API_ENDPOINT"] + "/api/leaverequest/findall?employeeid=10145", '', {})
            .then(function (data) {
            ...
            _this.sidebarVisibilityChange.next("test test");
        })
