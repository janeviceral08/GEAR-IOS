...
var MonthViewComponent = /** @class */ (function () {
    ...
    MonthViewComponent.prototype.getHighlightClass = function (date) {
        ...
        if (date.hasEvent) {
            ...
            // }
            if (date["events"][0]["type"] == "Holiday") {
                className = 'monthview-primary-with-event';
            } else if (date["events"][0]["type"] == "Leave") {
                className = 'monthview-secondary-with-event';
            } else if (date["events"][0]["type"] == "AttendanceAdvisory") {
                className = 'monthview-tertiary-with-event';
            } else if (date["events"][0]["type"] == "Approval") {
                className = 'monthview-fourth-with-event';
            } else if (date["events"][0]["type"] == "SubLeave") {
                className = 'monthview-sixth-with-event';
            } else if (date["events"][0]["type"] == "SubAdvisory") {
                className = 'monthview-fifth-with-event';
            } else if (date["events"][0]["type"] == "Wfh") {
                className = 'monthview-seventh-with-event';
            } else if (date["events"][0]["type"] == "SubWfh") {
                className = 'monthview-eigth-with-event';
            } 
            else {
                className = 'monthview-default-with-event';
            }
        }
        if (date.selected) {
            if (className) {
    ...
    MonthViewComponent = MonthViewComponent_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            styles: ["\n        .text-muted {\n          color: #999;\n        }\n\n        .table-fixed {\n          table-layout: fixed;\n        }\n\n        .table {\n          width: 100%;\n          max-width: 100%;\n          background-color: transparent;\n        }\n\n        .table > thead > tr > th, .table > tbody > tr > th, .table > tfoot > tr > th, .table > thead > tr > td,\n        .table > tbody > tr > td, .table > tfoot > tr > td {\n          padding: 6px;\n          line-height: 30px;\n          vertical-align: top;\n          font-size: 13px;\n        }\n\n        .table > thead > tr > th {\n          vertical-align: bottom;\n          border-bottom: 2px solid #ddd;\n        }\n\n        .table > thead:first-child > tr:first-child > th, .table > thead:first-child > tr:first-child > td {\n          border-top: 0\n        }\n\n        .table > tbody + tbody {\n          border-top: 2px solid #ddd;\n        }\n\n        .table-bordered {\n          border: none;\n        }\n\n        .table-bordered > tr, .table-bordered > tbody > tr, .table-bordered > tfoot > tr,\n        .table-bordered > tr > td, .table-bordered > tbody > tr > td, .table-bordered > tfoot > tr > td {\n          border: none;\n        }\n\n        .table-bordered > thead > tr > th, .table-bordered > thead > tr > td {\n          border-bottom-width: 2px;\n        }\n\n        .table-striped > tbody > tr:nth-child(odd) > td, .table-striped > tbody > tr:nth-child(odd) > th {\n          background-color: #f9f9f9\n        }\n\n        .monthview-primary-with-event {\n             background: radial-gradient(closest-side at 50% 57%,#0288D1 10%, transparent 15%);\n        }\n\n        .monthview-secondary-with-event {\n             background: radial-gradient(closest-side at 50% 57%,#558B2F 10%, transparent 15%);\n        }\n\n        .monthview-tertiary-with-event {\n             background: radial-gradient(closest-side at 50% 57%,#FFB300 10%, transparent 15%);\n        }\n\n        .monthview-fourth-with-event {\n             background: radial-gradient(closest-side at 50% 57%,#F44336 10%, transparent 15%);\n        }\n\n        .monthview-fifth-with-event {\n             background: radial-gradient(closest-side at 50% 57%,#9C27B0 10%, transparent 15%);\n        }\n\n        .monthview-sixth-with-event {\n             background: radial-gradient(closest-side at 50% 57%,#004D40 10%, transparent 15%) !important;\n        }\n\n      .monthview-seventh-with-event {\n             background: radial-gradient(closest-side at 50% 57%,#5552B7 10%, transparent 15%);\n        }\n\n     .monthview-eigth-with-event {\n             background: radial-gradient(closest-side at 50% 57%,#5552B7 10%, transparent 15%);\n        }\n\n   .monthview-default-with-event {\n             background: radial-gradient(closest-side at 50% 57%,black 10%, transparent 15%);\n        }\n\n        .monthview-current {\n          background: radial-gradient( transparent 65%, gray 75%, transparent 55%);\n          border-radius: 30px;\n        }\n\n        .monthview-selected {\n          background-color: #d3a828 !important;\n          color: white;\n          border-radius: 30px;\n        }\n\n        .monthview-datetable td.monthview-disabled {\n            color: lightgrey;\n            cursor: default;\n        }\n\n        .monthview-datetable th {\n          text-align: center;\n        }\n\n        .monthview-datetable td {\n          cursor: pointer;\n          text-align: center;\n        }\n\n        ::-webkit-scrollbar,\n        *::-webkit-scrollbar {\n          display: none;\n        }\n\n        .classTD {\n          width:45px;\n          height:45px;\n        }\n    "]
        }),
...
module.exports = "ion-list {\n  margin-top: 30px; }\n\nion-item {\n  margin: 0 0 0 15px;\n  --padding-start: 0px;\n  --inner-padding-end: 0px; }\n\nion-footer {\n  text-align: center; }\n\nion-checkbox {\n  width: 15px;\n  height: 15px;\n  --background-checked: #D3A828;\n  --border-color-checked: #D3A828;\n  --border-radius: 5px;\n  --border-color: gray; }\n\n.itemFilter {\n  margin: 10px; }\n\n.labelFilter {\n  font-size: 18px;\n  font-weight: bold; }\n\n.buttonClose {\n  font-size: 30px;\n  color: #7A7A7A; }\n\n.labelEntityName {\n  font-size: 12px;\n  padding-left: 5px; }\n\n.buttonFilter {\n  width: 95%;\n  height: 35px; }\n\n.legendColorHolidays {\n  height: 50px;\n  width: 50px;\n  background: radial-gradient(closest-side at 50% 50%, #0288D1 20%, transparent 25%); }\n\n.legendColorLeaves {\n  height: 50px;\n  width: 50px;\n  background: radial-gradient(closest-side at 50% 50%, #558B2F 20%, transparent 25%); }\n\n.legendColorAttendanceAdvisories {\n  height: 50px;\n  width: 50px;\n  background: radial-gradient(closest-side at 50% 50%, #FFB300 20%, transparent 25%); }\n\n.legendColorLeavesForApproval {\n  height: 50px;\n  width: 50px;\n  background: radial-gradient(closest-side at 50% 50%, #F44336 20%, transparent 25%); }\n\n.legendColorAdvisoryForApproval {\n  height: 50px;\n  width: 50px;\n  background: radial-gradient(closest-side at 50% 50%, #F44336 20%, transparent 25%); }\n\n.legendColorSubordinateLeave {\n  height: 50px;\n  width: 50px;\n  background: radial-gradient(closest-side at 50% 50%, #004D40 20%, transparent 25%); }\n\n.legendColorSubordinateAdvisory {\n  height: 50px;\n  width: 50px;\n  background: radial-gradient(closest-side at 50% 50%, #9C27B0 20%, transparent 25%); }\n\n.legendColorWfh {\n  height: 50px;\n  width: 50px;\n  background: radial-gradient(closest-side at 50% 50%, #5552B7 20%, transparent 25%); }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "ion-header {\n  position: unset; }\n\nion-toolbar {\n  --border-width: 0px !important; }\n\nion-item:last-child {\n  --border-width: 0px 0px 1px 0 !important; }\n\n.btnMenu {\n  padding: 0 0 0 5px; }\n\n.btnToday {\n  transition: visibility 0s, opacity 0.5s linear;\n  font-size: 13px; }\n\n.btnFilter {\n  margin-top: -5px; }\n\n.lblMonth {\n  font-size: 30px;\n  height: 46px; }\n\n.lblYear {\n  font-size: 12px;\n  color: #666666;\n  padding-top: 14px; }\n\n.classToday {\n  margin: 0px;\n  text-align: right; }\n\n.itmSync {\n  text-align: center; }\n\n.lblSync {\n  font-size: 12px;\n  color: #666666; }\n\n.itmTypeHoliday {\n  border-left: 15px solid #0288D1; }\n\n.itmTypeLeave {\n  border-left: 15px solid #558B2F; }\n\n.itmTypeLeaveForApproval {\n  border-left: 15px solid #F44336; }\n\n.itmTypeAdvisory {\n  border-left: 15px solid #FFB300; }\n\n.itmTypeLeaveSub {\n  border-left: 15px solid #004D40; }\n\n.itmTypeAdvisorySub {\n  border-left: 15px solid #9C27B0; }\n\n.itmTypeWfh {\n  border-left: 15px solid #5552B7; }\n\n.leaveimg {\n  width: 40px;\n  height: 40px;\n  margin-right: 15px;\n  margin-top: 10px;\n  margin-bottom: 10px; }\n\n.leaveDetails {\n  overflow: hidden;\n  white-space: nowrap;\n  text-overflow: ellipsis;\n  height: 50px; }\n\n.classForApprovalLabel {\n  font-size: 11px !important; }\n\n.leaveNameHoliday {\n  display: block;\n  margin-top: 15px;\n  font-size: 15px;\n  overflow: hidden;\n  white-space: nowrap;\n  text-overflow: ellipsis; }\n\n.leaveName {\n  display: block;\n  margin-top: 5px;\n  font-size: 15px;\n  overflow: hidden;\n  white-space: nowrap;\n  text-overflow: ellipsis; }\n\n.leaveStatus {\n  font-size: 11px;\n  margin-bottom: 5px;\n  color: #808080;\n  vertical-align: top; }\n\n@media screen and (max-height: 649px) {\n  .cardClass {\n    overflow-y: auto;\n    max-height: 20%;\n    margin-top: 0px;\n    margin-bottom: 0px;\n    box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); } }\n\n@media screen and (min-height: 650px) {\n  .cardClass {\n    overflow-y: auto;\n    max-height: 30%;\n    margin-top: 0px;\n    margin-bottom: 0px;\n    box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); } }\n\n@media screen and (min-height: 750px) {\n  .cardClass {\n    overflow-y: auto;\n    max-height: 40%;\n    margin-top: 0px;\n    margin-bottom: 0px;\n    box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); } }\n\n/*# sourceMappingURL=data:application/json;base64, */"
